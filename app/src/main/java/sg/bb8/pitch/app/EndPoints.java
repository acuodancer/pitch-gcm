...
public class EndPoints {
    ...
    public static final String USER_PRIVATE_ROOM = BASE_URL + "/user/_ID_/private_room_id";
    public static final String USER_PENDING_REQUEST = BASE_URL + "/user/_ID_/pending_request_id";
